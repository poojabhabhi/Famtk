...
module.exports = {
  ...
  run: async function ({ message, event, Reply, args, api, usersData }) {
    try {
      ...
      if (!prompt) {
        return api.sendMessage("Please provide questions or\nnemo gen cat\nnemo draw cat\nnemo art\nnemo imagine\nnemo sdxl", event.threadID, event.messageID);
      }
